...
const FoodWheelPage: React.FC = () => {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState('food-wheel');
  const [faqOpenIndex, setFaqOpenIndex] = useState(-1);
  const template = wheelTemplates.find(t => t.id === 'food-wheel');

  return (
    <>
      <SEO 
        title="Food Wheel | Spin for a Food Idea | Spin the Wheels"
        ...
        keywords="food wheel, meal picker, food ideas, food spinner, what to eat, meal decision, meal generator"
        canonical="/food-wheel"
      />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
                  Add excitement to your meals! Spin the Food Wheel to discover new dishes, plan your next meal, or challenge your taste buds with something different.
                </p>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Spin for a Dish</h3>
                  <p className="text-gray-600">Let the wheel pick your next meal and add excitement to your dining with a variety of delicious options to try</p>
                </div>
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <p className="text-gray-600">Discover new flavors and meal ideas by spinning the wheel and stepping out of your usual food choices</p>
                </div>
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <p className="text-gray-600">Make meals a group adventure by spinning together and letting everyone try something new and tasty</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <p className="text-gray-600">Turn family meals into a delightful experience by letting everyone participate in choosing the dish together</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">👥</div>
                  <h3 className="text-xl font-semibold mb-3">Group Gatherings</h3>
                  <p className="text-gray-600">Use the wheel for shared meals, potlucks, or parties to make food decisions easy and enjoyable for all</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">💡</div>
                  <h3 className="text-xl font-semibold mb-3">Solo Inspiration</h3>
                  <p className="text-gray-600">Find inspiration for solo meals and try new recipes or cuisines with a simple spin of the wheel</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10">
                ...
                <p className="text-base text-gray-500">
                  Everything you need to know about picking your food
                </p>
              </div>
              <div className="space-y-5">
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 0 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 0 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Every spin is completely random, giving all meal options an equal chance to be picked for your food</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 1 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 1 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Absolutely! Add your favorite meals or new recipes to the wheel for a personalized food experience</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 2 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 2 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Yes! The wheel is perfect for families, roommates, or friends who want to make food decisions together</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 3 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">🏡 Family meal ideas?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 3 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Use the wheel to inspire new recipes, meal ideas, or to make group orders more fun and spontaneous</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 4 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">🎲 Fun food games?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 4 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Try food-themed trivia, taste tests, or let the wheel decide who cooks next time for extra fun</p>
                  </div>
                </div>
              </div>
            </div>

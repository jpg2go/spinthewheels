...
const WheelOfBreakfastPage: React.FC = () => {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState('wheel-of-breakfast');
  const [faqOpenIndex, setFaqOpenIndex] = useState(-1);
  const template = wheelTemplates.find(t => t.id === 'wheel-of-breakfast');

  return (
    <>
      <SEO 
        title="Wheel of Breakfast | Spin for a Breakfast Idea | Spin the Wheels"
        ...
        keywords="breakfast wheel, meal picker, breakfast ideas, food spinner, what to eat, breakfast decision, meal generator"
        canonical="/wheel-of-breakfast"
      />
        ...
        <main className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
                  Start your morning with a spin! The Wheel of Breakfast brings fresh ideas to your table, making every day a delicious new adventure.
                </p>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  Breakfast Made Bright
                </h2>
                <p className="text-lg text-gray-600">
                  Your morning meal adventure starts here
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <p className="text-gray-600">Let the wheel pick your breakfast and add excitement to your morning with a variety of tasty options to try</p>
                </div>
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <p className="text-gray-600">Discover new flavors and meal ideas by spinning the wheel and stepping out of your usual breakfast choices</p>
                </div>
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="w-12 h-12 bg-pink-100 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">
                    🌞
                  </div>
                  <h3 className="text-lg font-semibold mb-2">Share the Joy</h3>
                  <p className="text-gray-600">Make breakfast a group adventure by spinning together and letting everyone try something new and delicious</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-gradient-to-br from-indigo-50 to-purple-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  Perfect for Every Breakfast Table
                </h2>
                <p className="text-lg text-gray-600">
                  Making every morning memorable
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">🏡</div>
                  <h3 className="text-xl font-semibold mb-3">Family Breakfasts</h3>
                  <p className="text-gray-600">Turn family breakfasts into a delightful experience by letting everyone participate in choosing the meal together</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">👥</div>
                  <h3 className="text-xl font-semibold mb-3">Roommate Mornings</h3>
                  <p className="text-gray-600">Use the wheel for shared breakfasts, brunches, or parties to make meal decisions easy and enjoyable for all</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">💡</div>
                  <h3 className="text-xl font-semibold mb-3">Solo Inspiration</h3>
                  <p className="text-gray-600">Find inspiration for solo breakfasts and try new recipes or cuisines with a simple spin of the wheel</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10">
                ...
                <p className="text-base text-gray-500">
                  Everything you need to know about picking your breakfast
                </p>
              </div>
              <div className="space-y-5">
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 0 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 0 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Every spin is completely random, giving all meal options an equal chance to be picked for your breakfast</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 1 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 1 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Absolutely! Add your favorite meals or new recipes to the wheel for a personalized breakfast experience</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 2 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 2 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Yes! The wheel is perfect for families, roommates, or friends who want to make breakfast decisions together</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 3 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">🏡 Family breakfast ideas?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 3 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Use the wheel to inspire new breakfast recipes, meal ideas, or to make group orders more fun and spontaneous</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 4 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">🎲 Fun breakfast games?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 4 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Try breakfast-themed trivia, taste tests, or let the wheel decide who cooks next time for extra fun</p>
                  </div>
                </div>
              </div>
            </div>
...
export default WheelOfBreakfastPage; 
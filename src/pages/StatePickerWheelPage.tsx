...
const StatePickerWheelPage: React.FC = () => {
  ...
  const [selectedTemplate, setSelectedTemplate] = useState('state-picker-wheel');
  const [faqOpenIndex, setFaqOpenIndex] = useState(-1);
  const template = wheelTemplates.find(t => t.id === 'state-picker-wheel');

  return (
    <>
      <SEO 
        title="State Picker | Spin for a US State | Spin the Wheels"
        ...
        keywords="state picker wheel, random state generator, US geography, state games, American states, travel planning"
        canonical="/state-picker-wheel"
      />
        ...
        <main className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
                  Which state will it be? Spin the State Picker Wheel and let fate choose a U.S. state for your next adventure, trivia game, or classroom activity.
                </p>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  American Discovery Begins
                </h2>
                <p className="text-lg text-gray-600">
                  Your state exploration journey starts here
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Pick Your State</h3>
                  <p className="text-gray-600">Let the wheel guide you through all fifty states, each offering unique attractions, cultures, and experiences to explore</p>
                </div>
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">
                    ⭐
                  </div>
                  <h3 className="text-lg font-semibold mb-2">Learn State Facts</h3>
                  <p className="text-gray-600">Discover fascinating details about each state's history, geography, landmarks, and unique characteristics</p>
                </div>
                <div className="text-center p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="w-12 h-12 bg-pink-100 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl">
                    🎯
                  </div>
                  <h3 className="text-lg font-semibold mb-2">Plan State Visits</h3>
                  <p className="text-gray-600">Transform random state selections into exciting travel plans, educational projects, or virtual exploration activities</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-gradient-to-br from-indigo-50 to-purple-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  Perfect for Every American Explorer
                </h2>
                <p className="text-lg text-gray-600">
                  Making state discovery exciting
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">🎓</div>
                  <h3 className="text-xl font-semibold mb-3">Geography Students</h3>
                  <p className="text-gray-600">Make learning about US states interactive and engaging with random selections and state specific exploration activities</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">🚗</div>
                  <h3 className="text-xl font-semibold mb-3">Road Trip Planning</h3>
                  <p className="text-gray-600">Discover unexpected destinations within the United States and create unique travel itineraries for your next adventure</p>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="text-4xl mb-4">🎲</div>
                  <h3 className="text-xl font-semibold mb-3">State Trivia Games</h3>
                  <p className="text-gray-600">Create engaging geography games and state knowledge challenges for classrooms, parties, or family gatherings</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10">
                ...
                <p className="text-base text-gray-500">
                  Everything you need to know about state selection
                </p>
              </div>
              <div className="space-y-5">
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 0 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">🗺️ Are all states included?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 0 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Yes! All fifty US states are available for selection, and you can customize the list based on your preferences</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 1 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">⭐ Can I customize regions?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 1 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Focus on specific regions like East Coast, West Coast, Midwest, or create custom state lists for targeted learning</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 2 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 2 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Ideal for teaching US geography! Learn about state capitals, landmarks, history, and unique characteristics</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 3 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">🚗 Travel planning tips?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 3 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Use it to plan state to state road trips, discover local attractions, or create themed vacation itineraries</p>
                  </div>
                </div>
                ...
                <div className={`transition-all duration-300 rounded-2xl shadow-lg bg-gradient-to-br from-white via-indigo-50 to-purple-50 border border-gray-100 group ${faqOpenIndex === 4 ? 'ring-2 ring-indigo-400' : ''}`}>
                  ...
                  >
                    <h3 className="text-lg md:text-xl flex-1 font-semibold">🎲 Fun game ideas?</h3>
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out px-7 ${faqOpenIndex === 4 ? 'max-h-40 py-4 opacity-100' : 'max-h-0 py-0 opacity-0'}`}>
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">Create state trivia contests, virtual road trip challenges, or state fact competitions for engaging learning experiences</p>
                  </div>
                </div>
              </div>
            </div>
...
export default StatePickerWheelPage; 